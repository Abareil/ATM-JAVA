...
número de identiﬁcación personal (NIP), seguida de la creación y la ejecución de
transacciones ﬁnancieras. Para autenticar un usuario y realizar transacciones, el ATM
...
saldo que indica la cantidad de dinero en la cuenta. [Nota: asumiremos que el banco
1TP Final – Programación Avanzada
planea construir sólo un ATM, por lo que no necesitamos preocuparnos para que
varios ATMs puedan acceder a esta base de datos al mismo tiempo. Lo que es más,
supongamos que el banco no realizará modiﬁcaciones en la información que hay en
...
razonable que no contemplaremos en esta instancia. No obstante, para simpliﬁcar
...
NIP (número de identiﬁcación personal) asociado con el número de cuenta
especiﬁcado.
...
2TP Final – Programación Avanzada
