...
/*
	private final Double topeExtraccionPorTransaccion = 400.0;
	...
	public void validarCuenta(Integer nroCta, Integer NIP) {
		BaseDeDatos bd = new BaseDeDatos();
		 ...
		 for (Cuenta cta : bd.getCuentas()) {
			 if (cta.getNumeroCta().equals(nroCta)  && cta.getNIP().equals(NIP)) {
				 cuenta = cta;
			 }
		 }
		 if(cuenta != null) {
	...
	public Double getTopeExtraccionPorTransaccion() {
		return topeExtraccionPorTransaccion;
	}
*/
